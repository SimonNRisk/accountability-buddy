...
import { getFirestore, collection, doc, updateDoc, DocumentReference } from "firebase/firestore";
...
export const updateItem = (docRef: DocumentReference, item: string, status: boolean) => {
  updateDoc(docRef, {
